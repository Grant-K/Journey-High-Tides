...
import { $DataComponentType_, $DataComponentMap, $DataComponentMap_, $DataComponentPatch_, $DataComponentPatch, $DataComponentMap$Builder } from "@package/net/minecraft/core/component";
...
import { $CapabilityCurios } from "@package/net/zhaiji/kubejscurios/curios";
...
declare module "@package/dev/latvian/mods/kubejs/item" {
    ...
    export class $ItemBuilder extends $ModelledBuilderBase<$Item> {
        ...
        disableRepair(): this;
        attachCuriosCapability(arg0: $CapabilityCurios): this;
        /**
    ...
    export class $ItemModificationKubeEvent$ItemModifications extends $Record implements $ItemComponentFunctions {
        ...
        disableRepair(): void;
        attachCuriosCapability(arg0: $CapabilityCurios): void;
