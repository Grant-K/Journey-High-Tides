import { $AdvancedOpenScreenPayload_, $AdvancedContainerSetDataPayload_, $FrozenRegistrySyncCompletedPayload, $AuxiliaryLightDataPayload_, $FrozenRegistryPayload_, $ClientboundCustomSetTimePayload_, $ConfigFilePayload_, $AdvancedAddEntityPayload_, $FrozenRegistrySyncStartPayload_, $SyncAttachmentsPayload_ } from "@package/net/neoforged/neoforge/network/payload";
