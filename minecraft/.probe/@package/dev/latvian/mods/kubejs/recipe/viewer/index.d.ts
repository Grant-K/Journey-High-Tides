...
declare module "@package/dev/latvian/mods/kubejs/recipe/viewer" {
     ...
     */
    export type $RecipeViewerEntryType$Component_<T> = { empty?: $Predicate_<any>, streamCodec?: $StreamCodec_<never, any>, type?: $TypeInfo_,  } | [empty?: $Predicate_<any>, streamCodec?: $StreamCodec_<never, any>, type?: $TypeInfo_, ];
