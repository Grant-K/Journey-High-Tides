...
import { $RecipeComponentValue, $RecipeComponent, $RecipeValidationContext, $ComponentRole, $RecipeComponentValueMap, $ComponentRole_ } from "@package/dev/latvian/mods/kubejs/recipe/component";
...
declare module "@package/dev/latvian/mods/kubejs/recipe" {
     ...
     */
    export type $AfterRecipesLoadedKubeEvent$MatchCx_ = { ops?: $RegistryOpsContainer, registries?: $RegistryAccessContainer, cx?: $Context, recipe?: $RecipeLikeKJS,  } | [ops?: $RegistryOpsContainer, registries?: $RegistryAccessContainer, cx?: $Context, recipe?: $RecipeLikeKJS, ];
