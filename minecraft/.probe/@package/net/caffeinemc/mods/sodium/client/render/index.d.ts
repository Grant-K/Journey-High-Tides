...
declare module "@package/net/caffeinemc/mods/sodium/client/render" {
    export class $SodiumWorldRenderer implements $SodiumWorldRendererExtension$1, $SodiumWorldRendererAccessor, $SodiumWorldRendererExtension {
        ...
        handler$ldm000$sable$scheduleRebuildForChunk(arg0: number, arg1: number, arg2: number, arg3: boolean, arg4: $CallbackInfo): void;
        ...
        handler$ldm000$sable$isTerrainRenderComplete(arg0: $CallbackInfoReturnable<any>): void;
        handler$ldm000$sable$markGraphDirty(arg0: $Camera, arg1: $Viewport, arg2: boolean, arg3: boolean, arg4: $CallbackInfo): void;
        handler$ldm000$sable$setupTerrain(arg0: $Camera, arg1: $Viewport, arg2: boolean, arg3: boolean, arg4: $CallbackInfo): void;
        handler$haf000$aeronautics$setupLevititeShaders(arg0: $RenderType, arg1: $ChunkRenderMatrices_, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
        handler$haf000$aeronautics$cleanupLevititeShaders(arg0: $RenderType, arg1: $ChunkRenderMatrices_, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
        handler$ldm000$sable$drawRenderSources(arg0: $RenderType, arg1: $ChunkRenderMatrices_, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
