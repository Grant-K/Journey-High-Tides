...
import { $MoveControl, $BodyRotationControl, $MoveControl$Operation, $LookControl } from "@package/net/minecraft/world/entity/ai/control";
import { $ItemStack } from "@package/net/minecraft/world/item";
import { $CompoundTag } from "@package/net/minecraft/nbt";
import { $SpellData } from "@package/io/redspace/ironsspellbooks/api/spells";
import { $AnimationState, $EntityDimensions, $EntityType_, $Entity$RemovalReason, $LivingEntity, $Saddleable, $PortalProcessor, $Pose_, $WalkAnimationState, $PlayerRideableJumping, $Mob } from "@package/net/minecraft/world/entity";
