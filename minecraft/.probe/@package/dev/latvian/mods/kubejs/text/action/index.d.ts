...
declare module "@package/dev/latvian/mods/kubejs/text/action" {
     ...
     */
    export type $TooltipActionType_<T> = { streamCodec?: $StreamCodec_<$RegistryFriendlyByteBuf, $TextAction>, type?: number,  } | [streamCodec?: $StreamCodec_<$RegistryFriendlyByteBuf, $TextAction>, type?: number, ];
}
