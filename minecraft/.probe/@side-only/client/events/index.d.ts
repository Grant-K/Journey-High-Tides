...
import { $BlockLeftClickedKubeEvent, $BlockBrokenKubeEvent, $BlockStoppedFallingKubeEvent, $BlockStartedFallingKubeEvent, $DetectorBlockKubeEvent, $BlockPlacedKubeEvent, $BlockRightClickedKubeEvent, $FarmlandTrampledKubeEvent, $BlockPickedKubeEvent } from "@package/dev/latvian/mods/kubejs/block";
...
import { $KubeJSCuriosEventJS$CurioCanEquip, $KubeJSCuriosEventJS$SlotModifiersUpdated, $KubeJSCuriosEventJS$CurioCanUnequip, $KubeJSCuriosEventJS$CurioAttributeModifier, $KubeJSCuriosEventJS$registerRenderer } from "@package/net/zhaiji/kubejscurios/kubejs";
...
import { $KubeJEIAddRecipeEvent, $KubeJEIAddCategoryEvent, $KubeJEISubtypesEvent } from "@package/com/miiickey/kubejei/kubejs/event";
...
import { $BasinOperationEventJS, $ContraptionBeforeBlockDestroyEventJS, $ContraptionAfterBlockDestroyEventJS, $DeployerUseEventJS, $BlockDestroyEventJS } from "@package/com/vomiter/kjscauto/machine";
...
declare global {
    ...
    namespace KubeJEIEvents {
        function recipes(handler: ((event: $KubeJEIAddRecipeEvent) => void)): void;
        function categories(handler: ((event: $KubeJEIAddCategoryEvent) => void)): void;
        function subtypes(handler: ((event: $KubeJEISubtypesEvent) => void)): void;
    }
