...
declare module "@package/net/minecraft/server/packs/metadata/pack" {
     ...
     */
    export type $PackMetadataSection_ = { supportedFormats?: ($InclusiveRange_<number>) | undefined, description?: $Component_, packFormat?: number,  } | [supportedFormats?: ($InclusiveRange_<number>) | undefined, description?: $Component_, packFormat?: number, ];
}
