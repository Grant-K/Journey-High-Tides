...
declare module "@package/com/mojang/serialization" {
    ...
    export interface $MapCodec<A> extends RegistryMarked<RegistryTypes.NeoforgeBiomeModifierSerializersTag, RegistryTypes.NeoforgeBiomeModifierSerializers> {}
     ...
     */
    export type $MapCodec_<A> = RegistryTypes.LithostitchedLoadPredicateType | RegistryTypes.LithostitchedBandlandsBandType | RegistryTypes.WorldgenMaterialCondition | RegistryTypes.LithostitchedProcessorConditionType | RegistryTypes.CreatePotatoProjectileRenderMode | RegistryTypes.BlockType | RegistryTypes.LithostitchedModifierType | RegistryTypes.WorldgenPoolAliasBinding | RegistryTypes.LithostitchedPlacementConditionType | RegistryTypes.EnchantmentEntityEffectType | RegistryTypes.MoonlightVillagerTrades | RegistryTypes.NeoforgeConditionCodecs | RegistryTypes.CreatePotatoProjectileBlockHitAction | RegistryTypes.LithostitchedBiomeInjectorType | RegistryTypes.NeoforgeStructureModifierSerializers | RegistryTypes.NeoforgeGlobalLootModifierSerializers | RegistryTypes.CreatePotatoProjectileEntityHitAction | RegistryTypes.IronsJewelryAction | RegistryTypes.WorldgenMaterialRule | RegistryTypes.EnchantmentValueEffectType | RegistryTypes.WorldgenChunkGenerator | RegistryTypes.SpectrumPastelPayloadType | RegistryTypes.LithostitchedFastNoiseConfigType | RegistryTypes.EnchantmentLocationBasedEffectType | RegistryTypes.WorldgenDensityFunctionType | RegistryTypes.SpawnConditionType | RegistryTypes.EnchantmentProviderType | RegistryTypes.WorldgenBiomeSource | RegistryTypes.SpectrumResonanceProcessorType | RegistryTypes.EntitySubPredicateType | RegistryTypes.EnchantmentLevelBasedValueType | RegistryTypes.NeoforgeBiomeModifierSerializers;
     ...
     */
    export type $DataResult$Error_<R> = { messageSupplier?: $Supplier_<string>, lifecycle?: $Lifecycle, partialValue?: (R) | undefined,  } | [messageSupplier?: $Supplier_<string>, lifecycle?: $Lifecycle, partialValue?: (R) | undefined, ];
