...
declare module "@package/net/neoforged/neoforge/network/payload" {
     ...
     */
    export type $ClientboundCustomSetTimePayload_ = { dayTime?: number, gameRule?: boolean, gameTime?: number, dayTimeFraction?: number, dayTimePerTick?: number,  } | [dayTime?: number, gameRule?: boolean, gameTime?: number, dayTimeFraction?: number, dayTimePerTick?: number, ];
     ...
     */
    export type $ModdedNetworkQueryComponent_ = { version?: string, id?: $ResourceLocation_, flow?: ($PacketFlow_) | undefined, optional?: boolean,  } | [version?: string, id?: $ResourceLocation_, flow?: ($PacketFlow_) | undefined, optional?: boolean, ];
     ...
     */
    export type $AdvancedContainerSetDataPayload_ = { value?: number, dataId?: number, containerId?: number,  } | [value?: number, dataId?: number, containerId?: number, ];
