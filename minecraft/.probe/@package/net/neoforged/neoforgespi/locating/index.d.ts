...
declare module "@package/net/neoforged/neoforgespi/locating" {
     ...
     */
    export type $ModFileDiscoveryAttributes_ = { parent?: $IModFile, dependencyLocator?: $IDependencyLocator_, reader?: $IModFileReader_, locator?: $IModFileCandidateLocator_,  } | [parent?: $IModFile, dependencyLocator?: $IDependencyLocator_, reader?: $IModFileReader_, locator?: $IModFileCandidateLocator_, ];
}
