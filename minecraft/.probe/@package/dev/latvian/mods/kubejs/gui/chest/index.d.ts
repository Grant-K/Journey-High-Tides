...
declare module "@package/dev/latvian/mods/kubejs/gui/chest" {
     ...
     */
    export type $ChestMenuClickHandler_ = { button?: number, type?: $ClickType_, callback?: $ChestMenuClickEvent$Callback_, autoHandle?: boolean,  } | [button?: number, type?: $ClickType_, callback?: $ChestMenuClickEvent$Callback_, autoHandle?: boolean, ];
