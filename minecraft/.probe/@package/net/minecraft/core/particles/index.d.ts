...
declare module "@package/net/minecraft/core/particles" {
    ...
    export class $SimpleParticleType extends $ParticleType<$SimpleParticleType> implements $ParticleOptions, $AccessSimpleParticleType, $SimpleParticleTypeAccessor {
        static createSimpleParticleType$platform_$md$68cb88$1(arg0: boolean): $SimpleParticleType;
        static init$bookshelf_$md$68cb88$0(arg0: boolean): $SimpleParticleType;
