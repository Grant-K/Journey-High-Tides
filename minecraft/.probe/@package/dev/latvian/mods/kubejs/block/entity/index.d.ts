...
declare module "@package/dev/latvian/mods/kubejs/block/entity" {
     ...
     */
    export type $EnergyStorageAttachment$Factory_ = { capacity?: number, maxExtract?: (number) | undefined, maxReceive?: (number) | undefined, autoOutput?: (number) | undefined,  } | [capacity?: number, maxExtract?: (number) | undefined, maxReceive?: (number) | undefined, autoOutput?: (number) | undefined, ];
