...
declare module "@package/dev/latvian/mods/kubejs/client/icon" {
     ...
     */
    export type $KubeIconType_<T> = { id?: $ResourceLocation_, streamCodec?: $StreamCodec_<$RegistryFriendlyByteBuf, $KubeIcon_>, codec?: $MapCodec_<$KubeIcon_>,  } | [id?: $ResourceLocation_, streamCodec?: $StreamCodec_<$RegistryFriendlyByteBuf, $KubeIcon_>, codec?: $MapCodec_<$KubeIcon_>, ];
