...
import { $EntityType_, $EquipmentSlot_, $Entity, $EquipmentSlot, $Mob } from "@package/net/minecraft/world/entity";
...
import { $GeckolibGeoArmorAccessor } from "@package/org/figuramc/figura/ducks";
import { $HumanoidModel$ArmPose, $HumanoidModel } from "@package/net/minecraft/client/model";
...
import { $GeoBone, $BakedGeoModel_, $GeoQuad_, $GeoCube_ } from "@package/software/bernie/geckolib/cache/object";
...
declare module "@package/software/bernie/geckolib/renderer" {
    export class $GeoEntityRenderer<T extends $Entity> extends $EntityRenderer<T> implements $GeoRenderer<T> {
        ...
        figura$renderPivots(poseStack: $PoseStack, geoAnimatable: $GeoAnimatable, bakedGeoModel: $BakedGeoModel_, renderType: $RenderType, multiBufferSource: $MultiBufferSource_, vertexConsumer: $VertexConsumer, isReRender: boolean, partialTick: number, packedLight: number, packedOverlay: number, color: number, ci: $CallbackInfo): void;
        figura$renderPivot(armorRenderer: $GeoArmorRenderer<any>, avatar: $Avatar, parentType: $ParentType_, geoAnimatable: $GeoAnimatable, geoBone: $GeoBone, renderType: $RenderType, multiBufferSource: $MultiBufferSource_, vertexConsumer: $VertexConsumer, isReRender: boolean, partialTick: number, packedLight: number, packedOverlay: number, color: number): boolean;
        figura$transformBasedOnType(bone: $GeoBone, poseStack: $PoseStack, parentType: $ParentType_): void;
        figura$prepareArmorRender(stack: $PoseStack): void;
    ...
    export interface $GeoRenderer<T extends $GeoAnimatable> {
        ...
        getInstanceId(arg0: T): number;
        getGeoModel(): $GeoModel<T>;
        actuallyRender(poseStack: $PoseStack, animatable: $GeoAnimatable, model: $BakedGeoModel_, renderType: $RenderType, bufferSource: $MultiBufferSource_, buffer: $VertexConsumer, isReRender: boolean, partialTick: number, packedLight: number, packedOverlay: number, color: number): void;
        applyRenderLayers(arg0: $PoseStack, arg1: T, arg2: $BakedGeoModel_, arg3: $RenderType, arg4: $MultiBufferSource_, arg5: $VertexConsumer, arg6: number, arg7: number, arg8: number): void;
        checkAndRefreshBuffer(arg0: boolean, arg1: $VertexConsumer, arg2: $MultiBufferSource_, arg3: $RenderType): $VertexConsumer;
        renderCubesOfBone(arg0: $PoseStack, arg1: $GeoBone, arg2: $VertexConsumer, arg3: number, arg4: number, arg5: number): void;
        applyRenderLayersForBone(arg0: $PoseStack, arg1: T, arg2: $GeoBone, arg3: $RenderType, arg4: $MultiBufferSource_, arg5: $VertexConsumer, arg6: number, arg7: number, arg8: number): void;
    ...
    export class $GeoArmorRenderer<T extends $Item> extends $HumanoidModel<any> implements $GeoRenderer<T>, $GeckolibGeoArmorAccessor {
        getRenderType(arg0: T, arg1: $ResourceLocation_, arg2: $MultiBufferSource_, arg3: number): $RenderType;
