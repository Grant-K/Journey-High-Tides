...
declare module "@package/dev/latvian/mods/kubejs/recipe/ingredientaction" {
     ...
     */
    export type $IngredientActionType_<T> = { id?: $ResourceLocation_, streamCodec?: $StreamCodec_<$RegistryFriendlyByteBuf, $IngredientAction>, codec?: $MapCodec_<$IngredientAction>,  } | [id?: $ResourceLocation_, streamCodec?: $StreamCodec_<$RegistryFriendlyByteBuf, $IngredientAction>, codec?: $MapCodec_<$IngredientAction>, ];
