...
declare module "@package/net/createmod/ponder/foundation/registration" {
    export class $PonderLocalization implements $LangRegistryAccess {
        ...
        handler$khl000$ponderjs$getTagName(arg0: $ResourceLocation_, arg1: $CallbackInfoReturnable<any>): void;
        handler$khl000$ponderjs$getTagDescription(arg0: $ResourceLocation_, arg1: $CallbackInfoReturnable<any>): void;
        handler$khl000$ponderjs$getSpecific(arg0: $ResourceLocation_, arg1: string, arg2: $CallbackInfoReturnable<any>): void;
        handler$khl000$ponderjs$getSpecific(arg0: $ResourceLocation_, arg1: string, arg2: $Object[], arg3: $CallbackInfoReturnable<any>): void;
